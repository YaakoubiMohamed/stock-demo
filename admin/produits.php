...
require 'bd.php';
$sql = "SELECT * FROM `article` , `categorie` where categorie.id = article.categorie_id";
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        $image_path = 'images/' . $row['photo'];
                        echo $image_path;
                        $image = '<img src="' . $image_path . '" alt="' . $row['designation'] . '" width="150">';
                    ?>
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-success" href="modifier_produit.php?id=<?php echo $row['id'] ?>">Update</a>
