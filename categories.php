...
$id = $_GET['id'];
$sql = "SELECT art.* FROM `article` art , `categorie` cat where cat.id = art.categorie_id AND art.categorie_id = $id";
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="detail_produit.php?id=<?php echo $row['id']; ?>" class="image">
                                                    <img class="main-image"
                                                        src="assets/images/<?php echo $row['photo'];?>" alt="Product" />
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <span class="ec-price">
                                                <span class="new-price"><?php echo $row['prix_unitaire'];?></span>
                                            </span>
