...
$cmd = "SELECT * FROM `commande` where client_id='".$_SESSION['id']."'";
$cmds = $conn->query($cmd);
?>
<!--========================================================= 
                                ...
                                <table class="table ec-table">
                                    ...
                                    while($row = $cmds->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span><?php echo $row['adresse_livraison']; ?></span></td>
                                            <td><span class="tbl-btn"><a class="btn btn-lg btn-primary"
                                                        href="detail_cmd.php?id=<?php echo $row['id']; ?>">View</a></span></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
