...
// Retrieve the line items associated with the order
$query = "SELECT article.designation, ligne_commande.quantite, article.prix_unitaire 
          FROM ligne_commande 
...
foreach ($line_items as $line_item) {
    $total_price += $line_item['quantite'] * $line_item['prix_unitaire'];
}
?>
<!--========================================================= 
                                                    ...
                                                    <div class="ec-vendor-card-table">
                                                        <table class="table ec-table">
                                                            ...
                                                            <?php foreach ($line_items as $line_item): ?>
                                                                <tr>
                                                                    <td><?php echo $line_item['designation']; ?></td>
                                                                    <td><?php echo $line_item['quantite']; ?></td>
                                                                    <td><?php echo $line_item['prix_unitaire']; ?></td>
                                                                    <td><?php echo $line_item['quantite'] * $line_item['prix_unitaire']; ?></td>
                                                                </tr>
                                                                <?php endforeach; ?>
                                                            ...
                                                            <tfoot>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="border-color m-m15">
                                                                        <span><?php echo $total_price; ?>DT</span></td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
